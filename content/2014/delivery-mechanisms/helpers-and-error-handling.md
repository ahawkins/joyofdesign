...
parameters and serializing objects. They are: `serialize`,
...
This chapter was short and sweet. All the helpers come together in the
[next chapter]({{< ref "route-handlers" >}}) on route handlers.
